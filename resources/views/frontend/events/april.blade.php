    ...
    <div class="container">
        <nav aria-label="breadcrumb" class="my-3">
          ...
          <div class="row d-flex justify-content-center">
              <div class="col-lg-4 ">
                <form action="{{ route('frontend.events.april') }}" method="GET" enctype="multipart/form">
                  <div class="row">
                      <div class="col-lg-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 my-lg-4 d-flex justify-content-center my-sm-2">
                ...
                <img src="{{ asset('assets/uploads/events/'.$apr->image) }}" class="card-img-top" alt="..." height="200">
                <div class="card-body">
                    ...
                    <div class="card-footer"><a href="{{ url('events-update/'.$apr->id) }}">Read Full</a></div>
                </div>
                </div>
            </div>
            @endforeach
