    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('update-traditions/'.$traditions->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $traditions->name }}" required autocomplete="name" autofocus>
                                @error('name')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <textarea id="editor" name="description" class="form-control rounded-0" id="exampleFormControlTextarea1" rows="10">{{ $traditions->description  }}</textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            @if ($traditions->image)
                            <img src="{{ asset('assets/uploads/traditions/'.$traditions->image) }}" alt="image" height="70" width="70">
                            @endif
