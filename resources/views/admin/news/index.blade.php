        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h1>News Page</h1>
                    <a href="{{ url('add-news') }}" class="btn btn-primary ml-auto">Create</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td class="row d-flex justify-content-center">
                                  <a href="{{ url('edit-news/'.$new->id) }}" class="btn btn-sm btn-outline-info mr-lg-2"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                  <a href="{{ url('delete-news/'.$new->id) }}" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                              </td>
                            </tr>                  
                            @endforeach          
                        </tbody>
