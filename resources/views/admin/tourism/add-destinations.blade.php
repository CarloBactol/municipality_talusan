    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('insert-destinations') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}"  required autocomplete="current-description">
